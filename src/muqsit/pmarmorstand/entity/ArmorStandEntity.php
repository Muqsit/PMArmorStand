...
class ArmorStandEntity extends Living{
	...
	public function setItemInHand(Item $item_in_hand) : void{
		...
		$packet = MobEquipmentPacket::create($this->getId(), TypeConverter::getInstance()->coreItemStackToNet($this->getItemInHand()), 0, ContainerIds::INVENTORY);
	...
	protected function sendSpawnPacket(Player $player) : void{
		...
		$player->getNetworkSession()->sendDataPacket(MobEquipmentPacket::create($this->getId(), TypeConverter::getInstance()->coreItemStackToNet($this->getItemInHand()), 0, ContainerIds::INVENTORY));
	}
